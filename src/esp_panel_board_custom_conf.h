 ...
 */
    ...
    /*    //     For refresh panel (DPI) 
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_CLK_MHZ            (70)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_PIXEL_BITS         (ESP_PANEL_LCD_COLOR_BITS_RGB888)
                                                                    // ESP_PANEL_LCD_COLOR_BITS_RGB565/RGB666/RGB888
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_HPW                (10)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_HBP                (80)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_HFP                (80)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_VPW                (4)
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_VBP                (36)

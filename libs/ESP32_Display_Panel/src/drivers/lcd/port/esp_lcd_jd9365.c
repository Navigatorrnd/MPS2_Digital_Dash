 ...
 */
                                    ...
                                    esp_lcd_panel_handle_t *ret_panel)
 {
     ...
     case LCD_RGB_ELEMENT_ORDER_RGB:
         jd9365->madctl_val = 0;
         ESP_LOGI(TAG, "color_space: %s", "LCD_RGB_ELEMENT_ORDER_RGB");
         break;
     case LCD_RGB_ELEMENT_ORDER_BGR:
         jd9365->madctl_val |= LCD_CMD_BGR_BIT;
         ESP_LOGI(TAG, "color_space: %s", "LCD_RGB_ELEMENT_ORDER_BGR");
         break;
     default:
     ...
     case 16: // RGB565
         ...
         ESP_LOGI(TAG, "colmod_val: %s", "RGB565");
         break;
     case 18: // RGB666
         jd9365->colmod_val = 0x66;
         ESP_LOGI(TAG, "colmod_val: %s", "RGB666");
         break;
     case 24: // RGB888
         jd9365->colmod_val = 0x77;
         ESP_LOGI(TAG, "colmod_val: %s", "RGB888");
         break;
     default:
 ...
 static esp_err_t panel_jd9365_init(esp_lcd_panel_t *panel)
 {
     ...
     ESP_LOGI(TAG, "JD9365_DSI_LANE_NUM %d", jd9365->lane_num);
     uint8_t ID[3];
